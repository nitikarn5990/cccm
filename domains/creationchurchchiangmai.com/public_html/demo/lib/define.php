...
define('TITLE', 'คริสตจักรสร้างสรรค์เชียงใหม่');
...
define('DB_USER', 'creatio2_demo');

define('DB_PASS', '0881545990');

define('DB_HOST', 'localhost');

define('DB_DEFAULT', 'creatio2_demo');
