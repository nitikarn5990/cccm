...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="da-panel collapsible">
            <div class="da-panel-header"> <span class="da-panel-title"> <i class="icol-<?php echo ($contact_message->GetPrimary() != '') ? 'email-open' : 'add'?>"></i> <?php echo ($contact_message->GetPrimary() != '') ? '' : ''?> Message </span> </div>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="da-panel collapsible">
            ...
            <div class="da-panel-content da-table-container">
                <table id="da-ex-datatable-sort" class="da-table" sort="1" order="desc" width="1500">
                    <thead>
                        <tr>
    ...
    onmouseout="this.className='whiteThing';">
                            ...
                            <td width="5%" class="center"><?php echo $row['status'] == '' ? '<img src='.ADDRESS_ASSETS.'email-new.png width="35" height="35">' : '<img src='.ADDRESS_ASSETS.'email-old.png width="35" height="35">';?></td>
                            <td width="7%" class="center"><?php echo $row['status'] == '' ? 'ยังไม่ได้อ่าน' : 'อ่านแล้ว';?></td>
